...
function playerThrowsRock(){
	...
	displaySelectionMessage(`Bot chose ${botsWeapon} / You chose Rock`);
}
//function for scissors
function playerThrowsScissors(){
	let botsWeapon=getRandomWeapon();
	checkWhoWon(botsWeapon,"scissors");
	displaySelectionMessage(`Bot chose ${botsWeapon} / you chose Scissors`);
}
//function for paper
function playerThrowsPaper(){
	let botsWeapon=getRandomWeapon();
	checkWhoWon(botsWeapon,"paper");
	displaySelectionMessage(`Bot chose ${botsWeapon} / you chose Paper`);
}
//function for paper
function playerThrowsLizard(){
	let botsWeapon=getRandomWeapon();
	checkWhoWon(botsWeapon,"lizard");
	displaySelectionMessage(`Bot chose ${botsWeapon} / you chose lizard`);
}
//function for paper
function playerThrowsSpock(){
	let botsWeapon=getRandomWeapon();
	checkWhoWon(botsWeapon,"spock");
	displaySelectionMessage(`Bot chose ${botsWeapon} / you chose Spock`);
}
